...
export const addDiscoveredDevice = (deviceId: string, signal?: AbortSignal) => {
  return customAxiosInstance<null>({ url: `/api/discovery/add-by-id/${deviceId}`, method: 'POST', signal })
}
...
export const addManualDevice = (address: string, signal?: AbortSignal) => {
  return customAxiosInstance<null>({ url: `/api/discovery/add-by-address/${address}`, method: 'POST', signal })
}
...
export const toggleDevice = (macAddress: string) => {
  return customAxiosInstance<null>({ url: `/api/devices/${macAddress}/toggle`, method: 'PUT' })
}
...
export const triggerAppleShortcutsCommand = (hash: string, signal?: AbortSignal) => {
  return customAxiosInstance<null>({ url: `/api/public/apple-shortcuts/${hash}`, method: 'POST', signal })
}

export const getTriggerAppleShortcutsCommandMutationOptions = <TError = null, TContext = unknown>(options?: {
  mutation?: UseMutationOptions<
...
export type TriggerAppleShortcutsCommandMutationError = null

/**
 * @summary Trigger a predefined command via apple shortcuts.
 */
export const useTriggerAppleShortcutsCommand = <TError = null, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof triggerAppleShortcutsCommand>>,
      TError,
...
export const toggleDevicePowerState = (macAddress: string, signal?: AbortSignal) => {
  return customAxiosInstance<null>({ url: `/api/public/stream-deck/toggle/${macAddress}`, method: 'GET', signal })
}
...
export const deleteCommand = (commandId: number) => {
  return customAxiosInstance<null>({ url: `/api/commands/${commandId}`, method: 'DELETE' })
}
