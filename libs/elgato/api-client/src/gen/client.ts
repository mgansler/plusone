...
export const useAddDiscoveredDevice = <TError = unknown, TContext = unknown>(
  ...
  return useMutation(getAddDiscoveredDeviceMutationOptions(options), queryClient)
}
...
export const useAddManualDevice = <TError = unknown, TContext = unknown>(
  ...
  return useMutation(getAddManualDeviceMutationOptions(options), queryClient)
}
...
export const getDeviceDetailsQueryOptions = <TData = Awaited<ReturnType<typeof deviceDetails>>, TError = unknown>(
  ...
  return {
    queryKey,
    queryFn,
    enabled: macAddress !== null && macAddress !== undefined,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof deviceDetails>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData, TError>
  }
}
...
export const setDisplayName = (
  macAddress: string,
  deviceDisplayNameRequestDto: DeviceDisplayNameRequestDto,
  signal?: AbortSignal,
) => {
...
export const useSetDisplayName = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  return useMutation(getSetDisplayNameMutationOptions(options), queryClient)
}

export const toggleDevice = (macAddress: string, signal?: AbortSignal) => {
  return customAxiosInstance<void>({ url: `/api/devices/${macAddress}/toggle`, method: 'PUT', signal })
}
...
export const useToggleDevice = <TError = unknown, TContext = unknown>(
  ...
  return useMutation(getToggleDeviceMutationOptions(options), queryClient)
}

export const deviceSetPowerState = (
  macAddress: string,
  devicePowerStateRequestDto: DevicePowerStateRequestDto,
  signal?: AbortSignal,
) => {
  return customAxiosInstance<void>({
...
export const useDeviceSetPowerState = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  return useMutation(getDeviceSetPowerStateMutationOptions(options), queryClient)
}

export const transitionToColor = (
  macAddress: string,
  transitionToColorRequestDto: TransitionToColorRequestDto,
  signal?: AbortSignal,
) => {
  return customAxiosInstance<void>({
...
export const useTransitionToColor = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  return useMutation(getTransitionToColorMutationOptions(options), queryClient)
}
...
>(
  ...
  return {
    ...
    enabled: macAddress !== null && macAddress !== undefined,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof currentDeviceSettings>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData, TError>
  }
}
...
export const updateDeviceSettings = (
  macAddress: string,
  deviceSettingsRequestDto: DeviceSettingsRequestDto,
  signal?: AbortSignal,
) => {
  return customAxiosInstance<DeviceSettingsResponseDto>({
    url: `/api/devices/${macAddress}/settings`,
...
export const useUpdateDeviceSettings = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  return useMutation(getUpdateDeviceSettingsMutationOptions(options), queryClient)
}
...
export const useTriggerAppleShortcutsCommand = <TError = void, TContext = unknown>(
  ...
  return useMutation(getTriggerAppleShortcutsCommandMutationOptions(options), queryClient)
}
...
>(
  ...
  return {
    ...
    enabled: macAddress !== null && macAddress !== undefined,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof toggleDevicePowerState>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData, TError>
  }
}
...
export const useCreateCommand = <TError = unknown, TContext = unknown>(
  ...
  return useMutation(getCreateCommandMutationOptions(options), queryClient)
}
...
export const getGetCommandQueryOptions = <TData = Awaited<ReturnType<typeof getCommand>>, TError = unknown>(
  ...
  return {
    queryKey,
    queryFn,
    enabled: commandId !== null && commandId !== undefined,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getCommand>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData, TError>
  }
}
...
export const updateCommand = (commandId: number, commandRequestDto: CommandRequestDto, signal?: AbortSignal) => {
  return customAxiosInstance<void>({
...
export const useUpdateCommand = <TError = unknown, TContext = unknown>(
  ...
  TContext
> => {
  return useMutation(getUpdateCommandMutationOptions(options), queryClient)
}

export const deleteCommand = (commandId: number, signal?: AbortSignal) => {
  return customAxiosInstance<void>({ url: `/api/commands/${commandId}`, method: 'DELETE', signal })
}
...
export const useDeleteCommand = <TError = unknown, TContext = unknown>(
  ...
  return useMutation(getDeleteCommandMutationOptions(options), queryClient)
}
