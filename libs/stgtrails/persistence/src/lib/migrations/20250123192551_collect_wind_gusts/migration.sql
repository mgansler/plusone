/*
  ...
  - Added the required column `windGusts10m` to the `WeatherData` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_WeatherData" (
    ...
    "windGusts10m" REAL NOT NULL DEFAULT 0,
...
INSERT INTO "new_WeatherData" ("id", "rain", "soilMoisture0To1cm", "soilMoisture1To3cm", "soilMoisture3To9cm", "soilMoisture9To27cm", "soilTemperature0cm", "soilTemperature6cm", "temperature2m", "time", "trailAreaId") SELECT "id", "rain", "soilMoisture0To1cm", "soilMoisture1To3cm", "soilMoisture3To9cm", "soilMoisture9To27cm", "soilTemperature0cm", "soilTemperature6cm", "temperature2m", "time", "trailAreaId" FROM "WeatherData";
