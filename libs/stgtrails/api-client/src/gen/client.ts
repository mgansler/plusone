...
export const deleteTrailArea = (trailAreaId: number) => {
  return customAxiosInstance<null>({ url: `/api/trailAreas/${trailAreaId}`, method: 'DELETE' })
}
...
export const deleteTrail = (trailId: number) => {
  return customAxiosInstance<null>({ url: `/api/trailAreas/trails/${trailId}`, method: 'DELETE' })
}
