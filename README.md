...
![main](https://github.com/mgansler/feeds/actions/workflows/main.yml/badge.svg)
...
Libraries are shareable across libraries and applications. They can be imported from `@feeds/mylib`.
